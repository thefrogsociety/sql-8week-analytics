...
SELECT
  ...
  END AS duration,
  CASE
    WHEN cancellation IS NULL OR cancellation IN ('null','NaN','')
    THEN NULL
    ELSE cancellation
  END AS cancellation
...
Customers 101 and 102 ordered pizzas without any modifications, while customers 103, 104, and 105 requested at least one change to the standard recipe.
...
Orders are concentrated around typical meal times, with a small peak at lunch (13:00) and stronger activity in the evening between 18:00 and 23:00, suggesting customers are more likely to order pizza for dinner than earlier in the day. 
